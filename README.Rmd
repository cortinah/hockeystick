...
- Thank you to Dirk Eddelbuettel for providing the .isConnected function from his [tint](https://cran.r-project.org/web/packages/tint/index.html) package to test for internet connectivity.
