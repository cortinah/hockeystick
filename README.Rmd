...
**New in version 0.7.0:** Globally averaged methane (CH~4~) concentration from NOAA (see below).

**New in version 0.7.0:** Cumulative emissions by country visualization (see below).

version 0.7.0:** Globally averaged methane (CH~4~) concentration from NOAA (see below).
## Installation
