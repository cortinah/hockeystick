...
- Add get_icecurves() and plot_icecurves() to visualize current and
  historic sea ice
...
- Add get_temp2k() and plot_temp2k() to visualize global Common Era
  reconstructed temp
...
- Add Atlantic hurricane data, get_hurricanes(), plot_hurricanes(),
  plot_hurricane_nrg()
