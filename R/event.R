...
i <- rbind(i,data.frame(year=2024,mo=12,extent=11.15))
...
fc |> filter(.model=='arima') |> autoplot(level = 50) + geom_hline(yintercept = 14.6) + scale_y_continuous(n.breaks = 10) + geom_hline(yintercept = 14)
