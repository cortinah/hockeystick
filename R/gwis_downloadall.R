...
# Valid AOI codes confirmed from the GWIS API
valid_aois <- c(
  "UN_EUR",   # Europe
  "UN_AFR",   # Africa
  "UN_ASI",   # Asia
...
# ── Fetch all AOIs x all years ────────────────────────────────────────────────

message("Fetching all regions x years...")
...
# ── Quick preview: total cumulative burnt area by region x year ───────────────
